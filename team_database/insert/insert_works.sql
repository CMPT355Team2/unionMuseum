...
-- delete from changedvalue where changedvalue.cvcode = '1444' and changedvalue.cvacronym = 'YHZ';
-- delete from owners where owners.owcode = '1444' and owners.owacronym = 'YHZ';
-- delete from transactions where transactions.trcode = '1444' and transactions.tracronym = 'YHZ';
-- delete from works_locations where works_locations.wlcode = '1444' and works_locations.wlacronym = 'YHZ';
